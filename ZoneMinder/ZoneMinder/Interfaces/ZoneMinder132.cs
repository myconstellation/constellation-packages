                ...
                if (datas != null)
                {
                    foreach (dynamic m in datas.monitors)
                    {
                        ...
                        result.Add(new Monitor2()
                        {
                            ...
                            SpaceUsed = m.Monitor.TotalEventDiskSpace == null ? -1 : long.Parse(m.Monitor.TotalEventDiskSpace.Value ?? "0"),
                            ...
                            TotalEvents = int.Parse(m.Monitor.TotalEvents.Value ?? "0"),
                            ...
                            ArchivedEvents = int.Parse(m.Monitor.ArchivedEvents.Value ?? "0"),
