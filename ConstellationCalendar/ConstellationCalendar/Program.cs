...
namespace ConstellationCalendar
{
    public class Program : PackageBase
    {

        static string[] Scopes = { CalendarService.Scope.Calendar };
        static string ApplicationName = "ConstellationCalendar";
        ...
        public override void OnStart()
        {
            ...
            int interval = PackageHost.GetSettingValue<int>("interval");
            int refresh = PackageHost.GetSettingValue<int>("refresh");

            createTokenFile(PackageHost.GetSettingValue("client_secret"));
            init();
        ...
        public void init()
        {
            try
            {
                  ...
                  new FileStream("client_secret.json", FileMode.Open, FileAccess.Read))
                {
                    ...
                    credPath = Path.Combine(credPath, ".credentials/constellation-calendar.json");
