...
namespace EcoPellets
{
    public class Program : PackageBase
    {
        ...
        /// <summary>
        /// Partie commune lors de la RÉCUP d'info
        /// </summary>
        static string getUrlPart = "recup.php?uniqid=";
        ...
        /// <summary>
        /// Rafraichissement de toutes les données
        /// </summary>
        [MessageCallback]
        public async void RefreshData()
        {
            await StockCourant();
            await ConsommationMoisCourant();
            await ConsommationMoisPrecedent();
            await Tendance();
            await NombreJoursAvantEpuisementStock();
        }
        ...
        [MessageCallback]
        public void CommandeSacs(int nbSac, float prix)
        {
        ...
        {
            PushStateObject("StockCourant", await Request($"{baseUrl}{getUrlPart}{uniqId}&info=qtestock"));
        }
        ...
        {
            PushStateObject("ConsommationMoisCourant", await Request($"{baseUrl}{getUrlPart}{uniqId}&info=qtemois"));
        }
        ...
        {
            PushStateObject("ConsommationMoisPrecedent", await Request($"{baseUrl}{getUrlPart}{uniqId}&info=qtelastmonth"));
        }
        ...
        {
            PushStateObject("Tendance", await Request($"{baseUrl}{getUrlPart}{uniqId}&info=tendance"));
        }
        ...
        {
            PushStateObject("NbJoursAvantEpuisementStock", await Request($"{baseUrl}{getUrlPart}{uniqId}&info=stock0"));
        }
