...
namespace HuaweiMobileRouter.Models
{
    ...
    /// <summary>
    /// Extended SIM information
    /// </summary>
    [StateObject, XmlRoot(ElementName = "response")] //api/pin/status
    public class PinStatus
    {
        [XmlElement(ElementName = "SimState")]
        public int SimState { get; set; }

        [XmlElement(ElementName = "PinOptState")]
        public int PinOptState { get; set; }

        [XmlElement(ElementName = "SimPinTimes")]
        public int SimPinTimes { get; set; }

        [XmlElement(ElementName = "SimPukTimes")]
