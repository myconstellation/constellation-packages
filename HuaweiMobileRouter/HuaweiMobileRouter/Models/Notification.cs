...
namespace HuaweiMobileRouter.Models
{
    ...
    /// </summary>
    [StateObject, XmlRoot(ElementName = "response")] //api/monitoring/check-notifications
    public class Notification
    {
        [XmlElement(ElementName = "UnreadMessage")]
        public int UnreadMessage { get; set; }

        [XmlElement(ElementName = "SmsStorageFull")]
        public int SmsStorageFull { get; set; }

        [XmlElement(ElementName = "OnlineUpdateStatus")]
