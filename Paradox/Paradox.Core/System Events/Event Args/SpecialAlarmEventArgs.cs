...
{
    /// <summary>
    /// Represent a Special alarm event
    /// </summary>
    public class SpecialAlarmEventArgs : AreaEventArgs
    {
        /// <summary>
        /// Gets the type of the special alarm.
        /// </summary>
        /// <value>
        /// The type of the special alarm.
        /// </value>
        public SpecialAlarmType AlarmType { get { return (SpecialAlarmType)this.EventNumber; } }
    }
}
