...
{
    /// <summary>
    /// Represent a Non-reportable event
    /// </summary>
    /// <seealso cref="Paradox.Core.AreaEventArgs" />
    public class NonReportableEventArgs : AreaEventArgs
    {
        /// <summary>
        /// Gets the Non-reportable event.
        /// </summary>
        /// <value>
        /// The Non-reportable event.
        /// </value>
        public NonReportableEventType Event { get { return (NonReportableEventType)this.EventNumber; } }
    }
}
