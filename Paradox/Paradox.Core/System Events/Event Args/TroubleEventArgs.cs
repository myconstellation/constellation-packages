...
{
    /// <summary>
    /// Represent a Trouble event
    /// </summary>
    public class TroubleEventArgs : AreaEventArgs
    {
        /// <summary>
        /// Gets the type of the trouble.
        /// </summary>
        /// <value>
        /// The type of the trouble.
        /// </value>
        public TroubleType TroubleType { get { return (TroubleType)this.EventNumber; } }
    }
}
