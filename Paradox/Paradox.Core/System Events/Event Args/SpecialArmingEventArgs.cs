...
{
    /// <summary>
    /// Represent a Special arming event
    /// </summary>
    /// <seealso cref="Paradox.Core.AreaEventArgs" />
    public class SpecialArmingEventArgs : AreaEventArgs
    {
        /// <summary>
        /// Gets the type of the special arming.
        /// </summary>
        /// <value>
        /// The type of the special arming.
        /// </value>
        public SpecialArmingType ArmingType { get { return (SpecialArmingType)this.EventNumber; } }
    }
}
