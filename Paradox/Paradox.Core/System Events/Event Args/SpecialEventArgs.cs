...
{
    /// <summary>
    /// Represent a Special event
    /// </summary>
    public class SpecialEventArgs : AreaEventArgs
    {
        /// <summary>
        /// Gets the type of the special event.
        /// </summary>
        /// <value>
        /// The type of the special event.
        /// </value>
        public SpecialEventType EventType { get { return (SpecialEventType)this.EventNumber; } }
    }
}
