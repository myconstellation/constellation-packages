...
{
    /// <summary>
    /// Represent a Special disarming event
    /// </summary>
    public class SpecialDesarmingEventArgs : AreaEventArgs
    {
        /// <summary>
        /// Gets the type of the desarming.
        /// </summary>
        /// <value>
        /// The type of the desarming.
        /// </value>
        public SpecialDisarmEventType DesarmingType { get { return (SpecialDisarmEventType)this.EventNumber; } }
    }
}
